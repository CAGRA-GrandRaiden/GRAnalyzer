	...
	while(ptr < te){
		...
		case ID_NimIn:
			for(i=0; i<rgn_size && rgn<te; i++){
				dr_append_r(&dr_data,&dr_data_index[0],"IPR",0,*rgn++);
			}
			break;
		case ID_MADC32:
					...
					case MADC32_HEADER_SIGNATURE_DATA:
						switch(madc32_signature->subheader){
							case MADC32_SUBHEADER_EVENT:
								...
								switch (madc_geo){
									case 0:
										dr_append_r(&dr_data,&dr_data_index[1],"MADC32_0_CH",0, madc_ch);
										dr_append_r(&dr_data,&dr_data_index[2],"MADC32_0_ADC",0, (double)madc_amplitude);
										break;
									case 1:
										dr_append_r(&dr_data,&dr_data_index[3],"MADC32_1_CH",0, madc_ch);
										dr_append_r(&dr_data,&dr_data_index[4],"MADC32_1_ADC",0, (double)madc_amplitude);
										break;
									case 2:
										dr_append_r(&dr_data,&dr_data_index[5],"MADC32_2_CH",0, madc_ch);
										dr_append_r(&dr_data,&dr_data_index[6],"MADC32_2_ADC",0, (double)madc_amplitude);
										break;
								}
								break;
		...
		case ID_TDC:
			for(i=0; i<rgn_size && rgn<te; i++){
				dr_append_r(&dr_data,&dr_data_index[7],"GR_TDC_OLD",0, (*rgn++ & 0x0FFF));
			}
			break;
		case ID_V830:
			for(i=0; i<rgn_size && rgn<te; i+=2){
				dr_append_r(&dr_data,&dr_data_index[8],"GR_V830",0, (rgn[0] | (rgn[1]<<16)));
				rgn+=2;
			}
			break;
		case ID_ADC_LAS:
			for(i=0; i<rgn_size && rgn<te; i++){
				dr_append_r(&dr_data,&dr_data_index[9],"LAS_ADC_OLD",0, *rgn++);
			}
			break;
		case ID_TDC_LAS:
			for(i=0; i<rgn_size && rgn<te; i++){
				dr_append_r(&dr_data,&dr_data_index[10],"LAS_TDC_OLD",0, (*rgn++ & 0x0FFF));
			}
			break;
		case ID_3377:
          ...
          data  = ((lr3377_data*)&lr3377)->data;
					switch(type){
					case 0x00:
						dr_append_r(&dr_data,&dr_data_index[11],"GR_WIRE_X1",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[12],"GR_TDC_X1",0, (double)data);
						break;
					case 0x01:
						dr_append_r(&dr_data,&dr_data_index[13],"GR_WIRE_BASE",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[14],"GR_TDC_BASE",0, (double)data);
						break;
					case 0x02:
						dr_append_r(&dr_data,&dr_data_index[15],"GR_WIRE_U1",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[16],"GR_TDC_U1",0, (double)data);
						break;
					case 0x03:
						dr_append_r(&dr_data,&dr_data_index[17],"GR_WIRE_V1",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[18],"GR_TDC_V1",0, (double)data);
						break;
					case 0x04:
						dr_append_r(&dr_data,&dr_data_index[19],"GR_WIRE_X2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[20],"GR_TDC_X2",0, (double)data);
						break;
					case 0x05:
						dr_append_r(&dr_data,&dr_data_index[21],"GR_WIRE_Y2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[22],"GR_TDC_Y2",0, (double)data);
						break;
					case 0x06:
						dr_append_r(&dr_data,&dr_data_index[23],"GR_WIRE_U2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[24],"GR_TDC_U2",0, (double)data);
						break;
					case 0x07:
						dr_append_r(&dr_data,&dr_data_index[25],"GR_WIRE_V2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[26],"GR_TDC_V2",0, (double)data);
						break;
					case 0x08:
						dr_append_r(&dr_data,&dr_data_index[27],"LAS_WIRE_X1",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[28],"LAS_TDC_X1",0, (double)data);
						break;
					case 0x09: /* E154 05DEC */
						w = wire & 0x3f;
            switch(wire>>6){
						case 0x00:
							dr_append_r(&dr_data,&dr_data_index[29],"LF_WIRE_X1",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[30],"LF_TDC_X1",0, (double)data);
							break;
						case 0x01:
							dr_append_r(&dr_data,&dr_data_index[31],"LF_WIRE_X2",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[32],"LF_TDC_X2",0, (double)data);
							break;
						case 0x02:
							dr_append_r(&dr_data,&dr_data_index[33],"LF_WIRE_X3",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[34],"LF_TDC_X3",0, (double)data);
							break;
						case 0x03:
							dr_append_r(&dr_data,&dr_data_index[35],"LF_WIRE_X4",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[36],"LF_TDC_X4",0, (double)data);
							break;
						}
						break;
					case 0x0a:
						...
						dr_append_r(&dr_data,&dr_data_index[37],"LAS_WIRE_U1",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[38],"LAS_TDC_U1",0, (double)data);
						break;
					case 0x0b:
						if(wire<50 || 200<=wire){
							break;
						}
						dr_append_r(&dr_data,&dr_data_index[39],"LAS_WIRE_V1",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[40],"LAS_TDC_V1",0, (double)data);
						break;
					case 0x0c:
						dr_append_r(&dr_data,&dr_data_index[41],"LAS_WIRE_X2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[42],"LAS_TDC_X2",0, (double)data);
						break;
					case 0x0d: /* E154 05DEC */
						w = (wire & 0x3e)>>1;
            switch((wire>>6)*2+(wire&0x01)){
						case 0x00:
							dr_append_r(&dr_data,&dr_data_index[43],"LF_WIRE_Y1",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[44],"LF_TDC_Y1",0, (double)data);
							break;
						case 0x01:
							dr_append_r(&dr_data,&dr_data_index[45],"LF_WIRE_Y2",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[46],"LF_TDC_Y2",0, (double)data);
							break;
						case 0x02: /* folowing order of Y4 and Y3 is correct */
							dr_append_r(&dr_data,&dr_data_index[47],"LF_WIRE_Y4",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[48],"LF_TDC_Y4",0, (double)data);
							break;
						case 0x03:
							dr_append_r(&dr_data,&dr_data_index[49],"LF_WIRE_Y3",0, (double)w);
							dr_append_r(&dr_data,&dr_data_index[50],"LF_TDC_Y3",0, (double)data);
							break;
						}
						break;
					case 0x0e:
						...
						dr_append_r(&dr_data,&dr_data_index[51],"LAS_WIRE_U2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[52],"LAS_TDC_U2",0, (double)data);
						break;
					case 0x0f:
						if(wire<50 || 200<=wire){
							break;
						}
						dr_append_r(&dr_data,&dr_data_index[53],"LAS_WIRE_V2",0, (double)wire);
						dr_append_r(&dr_data,&dr_data_index[54],"LAS_TDC_V2",0, (double)data);
						break;
					default:
					...
					case V1190_HEADER_ID_TM:
						...
						if(geo<8){
							...
							if(wire==V1190_BASE_TIME_CH && !v1190.tdc_measurement.trailing){
								base_time[geo] = data;
								dr_set_r(&dr_data,&dr_data_index[55],"V1190BASE",geo,data);
							}
						}
			...
			for(i=0; i<rgn_size/2 && rgn<te; i++){
				...
				switch(v1190.global_header.id){
					...
					case V1190_HEADER_ID_TM:
						...
						wire2 = (geo%2)*128+ch;
						dr_append_r(&dr_data,&dr_data_index[60],"V1190_RAW_CH",0, geo*128+wire);
						dr_append_r(&dr_data,&dr_data_index[61],"V1190_RAW_TDC",0, v1190.tdc_measurement.measurement);
						...
						if(qtc_ch>=0){
							if(v1190.tdc_measurement.trailing) {
								dr_append_r(&dr_data,&dr_data_index[62],"QTC_TRAILING_CH",0, qtc_ch);
								dr_append_r(&dr_data,&dr_data_index[63],"QTC_TRAILING_TDC",0, v1190.tdc_measurement.measurement - base_time[geo]);
							}
							else {
								dr_append_r(&dr_data,&dr_data_index[64],"QTC_LEADING_CH",0, qtc_ch);
								dr_append_r(&dr_data,&dr_data_index[65],"QTC_LEADING_TDC",0, v1190.tdc_measurement.measurement - base_time[geo]);
							}
						}*/
						if(ch==V1190_BUFCH_CH){
							dr_set_r(&dr_data,&dr_data_index[66],"BUFCH",geo, ddata);
						}
						...
						if(!v1190.tdc_measurement.trailing){
							if(wire>=0 && geo<8){
								switch(v1190_plane_map(geo,ch)){
         						case 0: // X1 Plane
										dr_append_r(&dr_data,&dr_data_index[67],"GR_WIRE_X1",0, (double)wire);
										dr_append_r(&dr_data,&dr_data_index[68],"GR_TDC_X1",0, ddata);
										break;
									case 1: // U1 Plane
										dr_append_r(&dr_data,&dr_data_index[69],"GR_WIRE_U1",0, (double)wire);
										dr_append_r(&dr_data,&dr_data_index[70],"GR_TDC_U1",0, ddata);
									  	break;
									case 2: // X2 Plane
										dr_append_r(&dr_data,&dr_data_index[71],"GR_WIRE_X2",0, (double)wire);
										dr_append_r(&dr_data,&dr_data_index[72],"GR_TDC_X2",0, ddata);
									 	break;
									case 3: // U2 Plane
										dr_append_r(&dr_data,&dr_data_index[73],"GR_WIRE_U2",0, (double)wire);
										dr_append_r(&dr_data,&dr_data_index[74],"GR_TDC_U2",0, ddata);
									  	break;
									}
							}
								...
								switch((int)(geo/2)){
									case 4://X1 plane 
										dr_append_r(&dr_data,&dr_data_index[75],"LAS_WIRE_X1",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[76],"LAS_TDC_X1",0, ddata);
										break;
									case 5://X1 plane, 3rd module
										wire2 = 128+16+ch; // ECL plugged on D input
										dr_append_r(&dr_data,&dr_data_index[77],"LAS_WIRE_X1",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[78],"LAS_TDC_X1",0, ddata);
										break;
									case 6://U1 plane 
										dr_append_r(&dr_data,&dr_data_index[79],"LAS_WIRE_U1",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[80],"LAS_TDC_U1",0, ddata);
										break;
									case 7://V1 plane 
										dr_append_r(&dr_data,&dr_data_index[81],"LAS_WIRE_V1",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[82],"LAS_TDC_V1",0, ddata);
										break;
									case 8://X2 plane 
										dr_append_r(&dr_data,&dr_data_index[83],"LAS_WIRE_X2",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[84],"LAS_TDC_X2",0, ddata);
										break;
									case 9://U2 plane 
										dr_append_r(&dr_data,&dr_data_index[85],"LAS_WIRE_U2",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[86],"LAS_TDC_U2",0, ddata);
										break;
									case 10://V2 plane 
										dr_append_r(&dr_data,&dr_data_index[87],"LAS_WIRE_V2",0, (double)wire2);
										dr_append_r(&dr_data,&dr_data_index[88],"LAS_TDC_V2",0, ddata);
										break;
									}
							}
							/*else if(geo == 24){
								detector_ch = ch;
								if(v1190.tdc_measurement.trailing) {
									dr_append_r(&dr_data,&dr_data_index[89],"SSD_TRAI_CH",0, detector_ch);
									dr_append_r(&dr_data,&dr_data_index[90],"SSD_TRAI_TDC",0, v1190.tdc_measurement.measurement - base_time[geo]);
								}
								else {
									dr_append_r(&dr_data,&dr_data_index[91],"SSD_LEAD_CH",0, detector_ch);
									dr_append_r(&dr_data,&dr_data_index[92],"SSD_LEAD_TDC",0, v1190.tdc_measurement.measurement - base_time[geo]);
								}
							}*/
					}
	  					break;
...
///////////////////////////////////////////////////////////////////////////////			
		...
		case ID_Scaler:
			for(i=0; i<rgn_size; i+=2){
				...
				dr_append_r(&dr_data,&dr_data_index[93],"SCALER",0, data);
			}
			break;
		case ID_CHKSUM:
			break;
		 ...
		 int             size;
{
	...
	while(1){
		...
		dr_clear();
		dr_set_r(&dr_data,&dr_data_index[94],"RUN_N",0, nrun);
#if USE_SEQ_NUMBER_IN_DATA
		dr_set_r(&dr_data,&dr_data_index[95],"EVENT_N",0, evt->eventNumber);
		dr_set_r(&dr_data,&dr_data_index[96],"BLOCK_N",0, nblk);
#else
		dr_set_r(&dr_data,&dr_data_index[97],"EVENT_N",0, nevt);
		dr_set_r(&dr_data,&dr_data_index[98],"BLOCK_N",0, nblk);
#endif
    dr_set_r(&dr_data,&dr_data_index[99],"EVENT_RCNP",0, 1);
		/* read the fields */
		if(ptr<=te){
